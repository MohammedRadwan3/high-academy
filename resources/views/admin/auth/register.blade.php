...
<head>
    ...
    <link rel="stylesheet" href="admin/assets/css/luno-style.css">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center">
                        <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
                            <form class="row g-3" method="POST" action="{{ route('admin.signup') }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="file" name="photo"
                                        class="dropify form-control form-control-lg @error('photo') is-invalid @enderror">
                                    @error('photo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
